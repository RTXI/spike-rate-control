...
SpikeRateController::SpikeRateController(void) : DefaultGUIModel("SpikeRateController",::vars,::num_vars) {
...
void SpikeRateController::execute(void) {
	...
	if(TIME>LastSpikeTime + 20*TargetISI) {
